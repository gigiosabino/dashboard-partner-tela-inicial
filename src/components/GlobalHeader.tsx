...
import { AlterarEmpresaModal } from "./AlterarEmpresaModal";
...
export function GlobalHeader({ title, subtitle }: GlobalHeaderProps) {
  ...
  const [alterarEmpresaOpen, setAlterarEmpresaOpen] = useState(false);
  ...
  return (
    <>
      ...
      <AlterarEmpresaModal 
        open={alterarEmpresaOpen} 
        onOpenChange={setAlterarEmpresaOpen} 
      />
    </>
  );
}
