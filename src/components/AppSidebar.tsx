        ...
        <div className="p-4">
          <SidebarGroup>
            <SidebarGroupContent>
              <SidebarMenu>
                <SidebarMenuItem>
                  <SidebarMenuButton asChild className="text-white hover:bg-gray-700 bg-gradient-to-r from-blue-700 to-blue-800 shadow-md border border-blue-600">
                    <Link to="/">
                    ...
                    {item.items.length > 0 ? (
                      <Collapsible>
                        <CollapsibleTrigger asChild>
                          <SidebarMenuButton className="text-gray-100 hover:bg-gray-700 hover:text-white w-full transition-all duration-200">
                          ...
                          <SidebarMenuSub>
                            {item.items.map((subItem) => (
                              <SidebarMenuSubItem key={subItem.title}>
                                <SidebarMenuSubButton asChild className="text-gray-200 hover:text-white hover:bg-gray-600 text-sm transition-all duration-200">
                      ...
                      <SidebarMenuButton asChild className="text-gray-100 hover:bg-gray-700 hover:text-white transition-all duration-200">
                        {item.url ? (
