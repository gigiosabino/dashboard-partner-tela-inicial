...
export function ImportacaoVisualizarModal({ 
  ...
  const renderFieldsBlock = (fields: any[], title: string) => (
    <Card className="mb-4">
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl bg-white max-h-[85vh]">
        <DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <ScrollArea className="h-[450px]">
            <div className="pr-4 space-y-4">
              {renderFieldsBlock(dadosImportacao.empresa, "Dados da Empresa")}
              {renderFieldsBlock(dadosImportacao.endereco, "Endereço da Empresa")}
              {renderFieldsBlock(dadosImportacao.contrato, "Condições do Contrato")}
              {renderFieldsBlock(dadosImportacao.assinante, "Dados do Assinante")}
            </div>
          </ScrollArea>
        </div>
      </DialogContent>
